...
export function SwapForm() {
  ...
  const handleReverseTradeDirection = useCallback(
    () => {
      dispatch(reverseTradeDirection());
      dispatch(refreshPrices());
    },
    [dispatch],
  );
      ...
      >
        ...
        >
          ...
          <div className="trade-direction">
            <Button type="link" onClick={handleReverseTradeDirection}>
          ...
          <Row>
            ...
            <Col flex="auto" style={{ textAlign: 'right' }}>
              {(sourceId && destinationSymbol && estimatePrice)
                ? `${estimatePrice} ${destinationSymbol} per ${sourceSymbol}`
                : '-'}
